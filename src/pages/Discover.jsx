...
const Discover = () => {
    ...
    return (
        <div className='flex flex-col'>
            <div className='w-full flex justify-between items-center sm:felx-row flex-col mt-4 mb-10'>
                <h2 className='font-bold text-3xl text-white text-left'>Discover {generetitle}</h2>
                <select
                    onChange={()=> {}}
                    value=""
                    className='bg-black text-gray-200 p-3 text-sm rounded-lg outline-none sm:mt-2 mt-5'
                >
